...
<ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
    <div class="container mt-3 mb-3 justify-content-center" style="margin-left: auto">
        <img src="{{ asset('images/logo/logo.png') }}" style="margin-left: auto;  margin-right:auto;" alt=""
            width="100px" width="50px" align="center">
    </div>
    ...
    <li class="nav-item">
        ...
        <div id="collapseInvoice" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Expensive:</h6>
                <a class="collapse-item" href="{{ url('/invoice') }}">Add Invoice</a>
            </div>
        </div>
    </li>
    <hr class="sidebar-divider">
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseo" aria-expanded="true"
            aria-controls="collapseTwo">
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseRC" aria-expanded="true"
            aria-controls="collapseTwo">
            <i class="fas fa-fw fa-cog"></i>
