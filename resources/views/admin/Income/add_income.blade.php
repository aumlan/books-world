...
<div class="container">
<button class="btn btn-primary float-right" data-toggle="" data-target="">report
</button>
<button type="button" class="btn btn-primary mb-4 mt-2" data-toggle="modal" data-target="#addModal">
 Add Income +
</button> <br>
</div>
